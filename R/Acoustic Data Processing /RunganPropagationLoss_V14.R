...
# Version 14. Wendy updated csv file for rungan_data
...
# Dena's old: rungan_data <- read.csv("data/PropLoss_test.csv")
# Wendy's new
...
write.csv(CombinedDF,'data/RunganPropLoss20250924_addcharacterized.csv',row.names = F)
